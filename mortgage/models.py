...
class MortgageCalculation(models.Model):
    ...
    grace_period_term = models.IntegerField(
        null=True, blank=True, verbose_name='Срок льготного периода, годы'
    )
    ...
    discount_markup_value = models.DecimalField(
        max_digits=5, decimal_places=2, default=0, verbose_name='Значение, %'
    )
