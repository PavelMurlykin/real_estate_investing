...
urlpatterns = [
    ...
    path('complexes/', views.RealEstateComplexListView.as_view(), name='complex_list'),
    path('complexes/create/', views.RealEstateComplexCreateView.as_view(), name='complex_create'),
    path('complexes/<int:pk>/update/', views.RealEstateComplexUpdateView.as_view(), name='complex_update'),
    path('complexes/<int:pk>/delete/', views.RealEstateComplexDeleteView.as_view(), name='complex_delete'),
