    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complex_class', models.CharField(choices=[('Бизнес', 'Бизнес'), ('Комфорт', 'Комфорт'), ('Комфорт+', 'Комфорт+'), ('Элит', 'Элит')], max_length=50, verbose_name='Класс ЖК')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='calculator.property', verbose_name='Объект')),
            ],
        ),
    ]
