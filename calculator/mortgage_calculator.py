...
class MortgageCalculator:
    ...
    def calculate(self):
        ...
        if self.has_grace_period:
            ...
            total_main_payments = main_monthly_payment * main_months
    ...
    def _generate_payment_schedule(self):
        ...
        if self.has_grace_period:
            ...
            grace_months = self.grace_period_term * 12
            monthly_grace_rate = self.grace_period_rate / 100 / 12
            grace_monthly_payment = current_balance * monthly_grace_rate
            ...
            annuity_coefficient = (monthly_main_rate * pow(1 + monthly_main_rate, main_months)) / \
                                  (pow(1 + monthly_main_rate, main_months) - 1)
            main_monthly_payment = current_balance * annuity_coefficient
