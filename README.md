...
рыночный ипотечный калькулятор с банковскими программами и графиком платежей,
сохранение расчёта для выбранного объекта, приватную историю и страницу
детального расчёта.
...
/app/mortgage, /app/mortgage/calculations и /app/mortgage/calculations/:id.
...
форма /mortgage/ сохранена для траншевых расчётов и проверки функционального
