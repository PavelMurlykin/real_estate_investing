...
Браузерная проверка общей навигации выполняется на запущенной production-сборке
в отдельной анонимной сессии Chromium. Она не изменяет данные приложения:
проверяет активные разделы, мобильное меню на 360 и 780 px, клавиатуру,
историю браузера, смену ширины экрана, задержку и ошибку загрузки страницы.
