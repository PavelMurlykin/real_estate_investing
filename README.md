...
ипотечных программ, программы застройщиков, импорт и ключевая ставка пока
...
справочников объектов, локаций, банков и ипотеки не удалены: Django-версии остаются
