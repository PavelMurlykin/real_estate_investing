...
Браузерные проверки дополняют компонентные тесты; приёмка остальных
пользовательских сценариев и окончательное переключение со старых URL
остаются отдельными этапами миграции.
