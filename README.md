...
главную страницу, каталог объектов с серверным поиском и пагинацией, а также
...
детального расчёта. React-маршруты доступны по адресам /app/,
/app/properties, /app/mortgage, /app/mortgage/calculations и
...
для траншевых расчётов, экспорта, удаления сохранённых расчётов и проверки
