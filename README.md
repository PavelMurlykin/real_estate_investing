...
управления доступны в React. Связанные программы застройщиков, сам импорт и
ключевая ставка пока остаются в сохранённом Django-интерфейсе.
...
справочников объектов, локаций, банков и ипотеки, включая канонические
ипотечные программы, не удалены: Django-версии остаются резервным интерфейсом
для проверки функционального паритета до завершения миграции.
